...
import type { StudentBalancesProps } from '../../types/payments'
            ...
            {enrollments.map((balance) => {
              ...
              return (
                <div
                  ...
                  className={`rounded-lg border p-3 ${isEmpty
                  ...
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <div className="text-right">
                      <div className="flex items-center gap-1">
                        ...
                        <span
                          className={`text-lg font-bold ${isEmpty
