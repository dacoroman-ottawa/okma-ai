...
export function ClassCard({
    ...
    return (
        <div
            onClick={onClick}
            className={`group h-full cursor-pointer overflow-hidden rounded-lg border p-2 text-xs transition-all hover:shadow-md ${isGroup
        ...
        >
            ...
            <div className="mb-1.5 flex items-center justify-between">
                ...
                <span
                    className={`rounded px-1.5 py-0.5 text-[10px] font-medium ${isGroup
